This is a blog collection.  It's where you might have several sequential pages listed in one place.  They can be nested, so any sub-pages you include will have some information about what pages are within that sub-collection.
